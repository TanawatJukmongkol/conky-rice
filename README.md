...
<h1> How to install: </h1>
  <ul>
    <li> open the terminal, copy and paste.</code> </li>
    <li> <code>cd $HOME</code> </li>
    <li> <code>sudo apt install conky-all libcairo-dev lm-sensors</code> </li>
    <li> <code>git clone https://github.com/TanawatJukmongkol/conky-rice.git .conky</code> </li>
    <li> <code>ln -s ~/.conky/.conkyrc ~/.conkyrc</code> </li>
    ...
    <ul>
      <li> <code>fc-cache -rf</code> </li>
      <li> Run conky, and set it as startup application with <code>conky -d --pause=3</code> </li>
    </ul>
  </ul>
<h1> How to install manually: </h1>
  <ul>
    <li> Install <code>conky, libcairo, libcairo-dev, lm-sensors</code> (or the conky-all meta package on Debian based systems) </li>
      and your fonts of choice (Mine's Hack Anonymice for Powerline). </li>
